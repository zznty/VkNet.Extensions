...
public record NeedValidationAuthResponse(LoginWay ValidationType, string ValidationSid, string? PhoneMask, LoginWay ValidationResend, string? ValidationExternalId);