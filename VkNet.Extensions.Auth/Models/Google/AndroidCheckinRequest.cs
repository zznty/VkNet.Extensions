...
public class AndroidCheckinRequest : IExtensible
{
	...
	public List<string> MacAddrs { get; } = new();

	[ProtoMember(19, Name = @"mac_addr_type")]
	public List<string> MacAddrTypes { get; } = new();
	...
	public List<string> AccountCookies { get; } = new();
	...
	public List<string> OtaCerts { get; } = new();
